...
import { Animated, View, ScrollView, Image, Text,useWindowDimensions,TouchableOpacity } from 'react-native';
...
const FirstRoute = () => (
	<View style={{ flex: 1, flexDirection:'row', flexWrap:'wrap',marginTop:1}} >
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect1.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect2.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect3.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect4.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect5.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect6.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
		<TouchableOpacity style={{width:windowWidth / 3,height:windowWidth/3,borderWidth:0.5,borderColor:'rgba(47, 53, 66, 1)'}}>
			<Image source={require("../assets/profile/rect5.png")} style={{width:'100%',height:'100%'}}/>
		</TouchableOpacity>
...
const ProfileScreen = ({route, navigation}) => {
	...
	useEffect(() => {
		setHeaderTitleOpacity(scrollY.interpolate({
	...
	useEffect(() => {
		if(type == 2)
		{
			navigation.setOptions({title:collapseType?setNavTitle():"liviavetrovs"})
		...
		return (
			<TouchableOpacity style={styles.navTitle}>
				<View style={styles.userAvatarContainer_nav}>
					<Image style={styles.userAvatar} source={require('../assets/profile/avatar.png')}></Image>
				</View>
	...
	const showNavRight = () => {
		return (
			<View style={styles.topRightHeader}>
				...
				<TouchableOpacity>
					<SvgXml style={{marginLeft:5}} width="24" height="24" xml={more_vertSvg} />
				</TouchableOpacity>
			</View>
		)
	}
	...
	const renderLabel = ({route,focused}) => {
		...
		return (
			<SvgXml width="24" height="24" fillOpacity={focused?1:0.5} xml={curTabSvg} />
		)
	}
	...
	const renderTabBar = props => (
		<TabBar
			...
			style={{ backgroundColor: '#242A38' ,borderTopWidth:1,borderColor:'rgba(24, 30, 44, 1)'}}
	...
	return (
		...
		>
			<View style={styles.innerContainer}>
				...
				showsVerticalScrollIndicator={false} style={styles.scrollContainer} contentContainerStyle={{

				}}>
					<Animated.View style={{opacity:headerTitleOpacity}}>
						<Image source={require('../assets/profile/back.png')} style={styles.profileBack}/>
					...
					<Animated.View style={{alignItems:'center',opacity:headerTitleOpacity}}>
						<Text style={styles.userProfileName}>Livia Vetrovs</Text>
						<Text style={styles.userJob}>UI/UX Designer at CloudES</Text>
					</Animated.View>
					
					{type == 2 &&<View style={{flexDirection:'row',width:windowWidth,justifyContent:'center',marginTop:18}}>
						<TouchableOpacity style={styles.followButton}>
							<LinearGradient start={{x:0,y:0}} end={{x:1,y:0}} style={{width:'100%',height:'100%',borderRadius:24,alignItems:'center',justifyContent:'center'}} colors={['rgba(255, 81, 47, 1)', 'rgba(240, 152, 25, 1)']}
							>
					...
					{type == 1 &&<View style={{flexDirection:'row',width:windowWidth,justifyContent:'center',marginTop:18}}>

						<TouchableOpacity style={styles.mymessageButton} onPress={()=>goEditProfile()}>
							<SvgXml width="16" height="16" style={{marginRight:10}} xml={editPenSvg}/>
				...
				<View style={styles.footer}>
					...
					<TouchableOpacity onPress={()=>goMyProfile()}>
						<SvgXml width="24" height="24" xml={type==2?profileSvg:profileOnSvg} />
					</TouchableOpacity>
				</View>
