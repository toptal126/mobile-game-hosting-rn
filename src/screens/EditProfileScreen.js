...
import { View,ScrollView,KeyboardAvoidingView, Image, Text,TouchableOpacity } from 'react-native';
...
const EditProfileScreen = ({route, navigation}) => {
	...
	const [bioText,setBioText] = useState("UI/UX Designer\nCo-founder at Nolan Designs\nAvailable to work overtime");
			...
			<View style={styles.innerContainer}>
				...
				<ScrollView showsVerticalScrollIndicator={false} style={styles.scrollContainer} contentContainerStyle={{
					...
					<View>
						...
						<LinearGradient style={styles.bottomBack} colors={['rgba(0, 0, 0, 0)', 'rgba(0, 0, 0, 1)']}
						>
						...
						<View style={styles.profileAvatarView}>
							...
							<Image source={require('../assets/profile/myavatar.png')} style={styles.profileAvatar}/>
							<TouchableOpacity style={{position:'absolute',left:90,bottom:0,borderRadius:50,width:30,height:30,borderWidth:4,borderColor:'rgba(47, 53, 66, 1)',backgroundColor:'rgba(255, 121, 52, 1)',alignItems:'center',justifyContent:'center'}}>
					...
					<View style={styles.editItem}>
						...
						<TextInput style={styles.fieldInput} value="www.nolanportfolio.com"/>
					</View>

					<View style={styles.editItem}>
						<Text style={styles.fieldLabel}>Bio</Text>
						<TextInput multiline={true} onChangeText={(text)=>setBioText(text)} style={styles.fieldInput}  value={bioText}/>
					</View>
